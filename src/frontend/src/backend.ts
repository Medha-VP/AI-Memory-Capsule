...
import type { AnalyticsOverview as _AnalyticsOverview, CategoryCount as _CategoryCount, Cell as _Cell, DocumentCategory as _DocumentCategory, DocumentView as _DocumentView, Error as _Error, ExternalBlob as _ExternalBlob, PasswordError as _PasswordError, Result as _Result, Result_1 as _Result_1, Result__1 as _Result__1, UserRole as _UserRole, Value as _Value, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async changeDocumentPassword(arg0: bigint, arg1: string): Promise<Result> {
        if (this.processError) {
            try {
                const result = await this.actor.changeDocumentPassword(arg0, arg1);
    ...
    async getAnalyticsOverview(): Promise<AnalyticsOverview> {
        if (this.processError) {
            try {
                const result = await this.actor.getAnalyticsOverview();
                return from_candid_AnalyticsOverview_n26(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getDocument(arg0: bigint, arg1: string | null): Promise<DocumentView | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDocument(arg0, to_candid_opt_n35(this._uploadFile, this._downloadFile, arg1));
    ...
    async getKnowledgeGraph(): Promise<KnowledgeGraph> {
        if (this.processError) {
            try {
                const result = await this.actor.getKnowledgeGraph();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUploadTrends(): Promise<Array<UploadTrendPoint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUploadTrends();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listDocuments(): Promise<Array<DocumentView>> {
        if (this.processError) {
            try {
    ...
    async removeDocumentPassword(arg0: bigint): Promise<Result> {
        if (this.processError) {
            try {
                const result = await this.actor.removeDocumentPassword(arg0);
                return from_candid_Result_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchDocuments(arg0: string): Promise<Array<DocumentView>> {
        if (this.processError) {
            try {
    ...
    async setDocumentPassword(arg0: bigint, arg1: string): Promise<Result> {
        if (this.processError) {
            try {
                const result = await this.actor.setDocumentPassword(arg0, arg1);
                return from_candid_Result_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadDocument(arg0: string, arg1: string, arg2: ExternalBlob, arg3: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadDocument(arg0, arg1, await to_candid_ExternalBlob_n44(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n35(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async verifyDocumentPassword(arg0: bigint, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.verifyDocumentPassword(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AnalyticsOverview_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AnalyticsOverview): AnalyticsOverview {
    return from_candid_record_n27(_uploadFile, _downloadFile, value);
}
function from_candid_CategoryCount_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CategoryCount): CategoryCount {
...
function from_candid_DocumentCategory_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DocumentCategory): DocumentCategory {
    return from_candid_variant_n32(_uploadFile, _downloadFile, value);
}
async function from_candid_DocumentView_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DocumentView): Promise<DocumentView> {
...
function from_candid_PasswordError_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PasswordError): PasswordError {
...
async function from_candid_opt_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DocumentView]): Promise<DocumentView | null> {
    return value.length === 0 ? null : await from_candid_DocumentView_n37(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DocumentCategory]): DocumentCategory | null {
    return value.length === 0 ? null : from_candid_DocumentCategory_n31(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    byCategory: Array<_CategoryCount>;
    totalDocuments: bigint;
}): {
    byCategory: Array<CategoryCount>;
    totalDocuments: bigint;
    ...
    return {
        byCategory: from_candid_vec_n28(_uploadFile, _downloadFile, value.byCategory),
...
function from_candid_record_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        count: value.count,
        category: from_candid_DocumentCategory_n31(_uploadFile, _downloadFile, value.category)
    };
}
async function from_candid_record_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        blob: record_opt_to_undefined(await from_candid_opt_n39(_uploadFile, _downloadFile, value.blob)),
        name: record_opt_to_undefined(from_candid_opt_n41(_uploadFile, _downloadFile, value.name)),
        locked: value.locked,
        fileType: record_opt_to_undefined(from_candid_opt_n41(_uploadFile, _downloadFile, value.fileType)),
        summary: record_opt_to_undefined(from_candid_opt_n41(_uploadFile, _downloadFile, value.summary)),
        category: record_opt_to_undefined(from_candid_opt_n42(_uploadFile, _downloadFile, value.category)),
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "ok" in value ? {
        ...
        __kind__: "err",
        err: from_candid_PasswordError_n16(_uploadFile, _downloadFile, value.err)
    } : value;
}
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "noPassword" in value ? PasswordError.noPassword : "alreadySet" in value ? PasswordError.alreadySet : "notFound" in value ? PasswordError.notFound : "notOwner" in value ? PasswordError.notOwner : value;
}
...
function from_candid_variant_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "finance" in value ? DocumentCategory.finance : "projects" in value ? DocumentCategory.projects : "education" in value ? DocumentCategory.education : "insurance" in value ? DocumentCategory.insurance : "achievements" in value ? DocumentCategory.achievements : "identity" in value ? DocumentCategory.identity : value;
}
...
function from_candid_vec_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CategoryCount>): Array<CategoryCount> {
    return value.map((x)=>from_candid_CategoryCount_n29(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n43(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DocumentView>): Promise<Array<DocumentView>> {
    return await Promise.all(value.map(async (x)=>await from_candid_DocumentView_n37(_uploadFile, _downloadFile, x)));
}
